<?php
// Login logic placeholder (add DB logic as needed)
$msg = '';
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($email && $password) {
    ...
    exit;
    // If invalid, show error (uncomment below for real logic)
    // $msg = '<div class="alert alert-danger text-center">Invalid email or password.</div>';
  } else {
    $msg = '<div class="alert alert-danger text-center">Please enter both email and password.</div>';
  }
}
?>
<!DOCTYPE html>
